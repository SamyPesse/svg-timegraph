...
Graph.prototype.bindSeries = function(series) {
    ...
    if (this.opts.autoFill) {
        if (!this.opts.autoFillInterval) throw "Need an interval to use autoFill";

        // Set valueMin and valueMax
        this.valueMin = Math.min(this.valueMin, this.opts.autoFillValue);
        this.valueMax = Math.max(this.valueMax, this.opts.autoFillValue);
        ...
        series = _.map(series, function(serie, i) {
            ...
            serie.points = _.map(_.range(this.dateMin, this.dateMax + autoFillInterval, autoFillInterval), function(time) {
                var data = null;
...
Graph.prototype.drawAxeY = function() {
    ...
    _.each(_.range(this.axeYInterval), function(i) {
        ...
        var y = that.opts.height - (that.axeXHeight + (value * that.hPerValue));
...
Graph.prototype.drawAxeX = function() {
    ...
    _.each(_.range(this.axeXInterval), function(i) {
        ...
        var x = that.axeYWidth + (value * that.wPerMS);
